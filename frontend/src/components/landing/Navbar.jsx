        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-1">
            ...
            <a
              ...
              className="ml-4 px-4 py-2 border border-gray-300 text-gray-700 text-sm font-medium hover:text-black hover:bg-gray-100 transition-colors flex items-center space-x-2"
            >
            ...
            <a
              href="#chat"
              className="ml-2 px-4 py-2 bg-black text-white text-sm font-medium hover:bg-gray-800 transition-colors"
            >
              Try it
            </a>
          </div>
          ...
          <div className="md:hidden">
            <button
              ...
              className="p-2 min-w-11 min-h-11 inline-flex items-center justify-center text-gray-700 hover:text-black hover:bg-gray-100 transition-colors"
            >
              {mobileMenuOpen ? (
          ...
          <div className="px-4 py-3 space-y-1">
            {menuItems.map((item) => (
              <a
                ...
                className="block px-4 py-3 text-sm font-medium text-gray-700 hover:text-black hover:bg-gray-100 transition-colors"
              >
                {item.name}
                {item.external && (
            ...
            <a
              href="#chat"
              onClick={() => setMobileMenuOpen(false)}
              className="block px-4 py-3 bg-black text-white text-sm font-medium hover:bg-gray-800 transition-colors"
            >
              Try it
            </a>
